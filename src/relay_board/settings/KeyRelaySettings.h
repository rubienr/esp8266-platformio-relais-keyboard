...
template<uint8_t keys_count, uint8_t key_event_types_count, uint8_t relays_count>
struct RelaySettingsTemplate : public KeyEventRelayActionTemplate<keys_count, key_event_types_count, relays_count> {
...
namespace {
    ...
    constexpr uint8_t relays_count = StaticSettings::Relay::COUNT;
}
using KeyRelaySettings = RelaySettingsTemplate<keys_count, events_count, relays_count>;
